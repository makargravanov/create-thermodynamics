...
data class ReactorControllerUiSnapshot(
    ...
    fun toGeneratedState(
        ...
        return ReactorControllerGeneratedState(
            ...
            overviewSelected = selectedTab == ReactorControllerTab.Overview,
            zonesSelected = selectedTab == ReactorControllerTab.Zones,
            mixtureSelected = selectedTab == ReactorControllerTab.Mixture,
            ...
            selectedZoneMixtureCompactCount = "${mixture.size} subs",
...
data class ReactorControllerGeneratedState(
    ...
    val overviewSelected: Boolean,
    val zonesSelected: Boolean,
    val mixtureSelected: Boolean,
    val selectedTabLabel: String,
    val selectedZoneTitle: String,
    val selectedZoneTemperature: String,
    val selectedZonePressure: String,
    val selectedZoneMixtureCompactCount: String,
