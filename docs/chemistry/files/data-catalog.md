...
[[core-registry|реестра химии]]. Описывает ~165 явных веществ (`DESTROY_SUBSTANCES`),
...
- `DESTROY_SUBSTANCE_COUNT` (165) и итоговый `registry.substance_count()` (211) проверяются в тесте.
  Разница — вещества, порождённые неявно (металлы + ионы + материалы = 46).
