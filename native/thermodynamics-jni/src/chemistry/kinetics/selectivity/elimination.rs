...
pub fn evaluate_e2(site: &SiteDescriptor, context: &SelectivityContext) -> ReactivityScore {
...
pub fn zaitsev_hofmann_ratio(site: &SiteDescriptor, context: &SelectivityContext) -> f64 {
    ...
    let temp_factor = if context.is_high_temperature() {
        1.2
    } else {
        1.0
    };
