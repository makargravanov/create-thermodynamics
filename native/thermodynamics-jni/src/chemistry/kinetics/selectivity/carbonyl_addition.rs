...
pub fn evaluate_carbonyl_addition(
    ...
    let score = carbonyl_factor * steric_factor * electronic_factor * aromatic_penalty 
                * nucleophile_factor * solvent_factor;
    
    let mut reactivity = ReactivityScore::new(
        score,
        format!(
            "Carbonyl add: {:?}, steric={:.2}, EDG={}, aromatic={}",
            carbonyl.degree, steric_factor,
...
/// Nucleophile strength classification
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum NucleophileStrength {
    VeryStrong,  // Grignard, organolithium
    Strong,      // NaBH4, LiAlH4
    Moderate,    // Hydroxide, cyanide, amines
    Weak,        // Water, alcohols (require acid/base catalysis)
}
...
mod tests {
    ...
    fn aldehyde_more_reactive_than_ketone() {
        ...
        let ald = evaluate_carbonyl_addition(&acetaldehyde, NucleophileStrength::Moderate, &context);
    ...
    fn aromatic_aldehyde_deactivated() {
        ...
        let arom = evaluate_carbonyl_addition(&benzaldehyde, NucleophileStrength::Moderate, &context);
        let aliph = evaluate_carbonyl_addition(&acetaldehyde, NucleophileStrength::Moderate, &context);
    ...
    fn nucleophile_strength_effect() {
        ...
        let strong = evaluate_carbonyl_addition(&acetone, NucleophileStrength::VeryStrong, &context);
