...
struct RawSubstance {
    ...
    critical_temperature_kelvin: Option<f64>,
    critical_pressure_pascal: Option<f64>,
    density: Option<f64>,
...
impl RawSubstance {
    fn to_substance(self) -> ChemistryResult<Substance> {
        ...
        let substance = match (
            ...
            (Some(tc), Some(pc)) => substance.with_critical_point(tc, pc),
            _ => substance,
        };
...
const DESTROY_SUBSTANCES: &[RawSubstance] = &[
    ...
    RawSubstance {
        ...
        boiling_point_kelvin: None,
        critical_temperature_kelvin: Some(508.1),
        critical_pressure_pascal: Some(4_700_000.0),
        density: Some(784.5),
    ...
    RawSubstance {
        ...
        boiling_point_kelvin: None,
        critical_temperature_kelvin: Some(405.4),
        critical_pressure_pascal: Some(11_353_000.0),
        density: Some(900.0),
    ...
    RawSubstance {
        ...
        boiling_point_kelvin: None,
        critical_temperature_kelvin: Some(304.13),
        critical_pressure_pascal: Some(7_377_300.0),
        density: Some(827.3),
    ...
    RawSubstance {
        ...
        boiling_point_kelvin: None,
        critical_temperature_kelvin: Some(513.9),
        critical_pressure_pascal: Some(6_148_000.0),
        density: Some(789.45),
    ...
    RawSubstance {
        ...
        boiling_point_kelvin: None,
        critical_temperature_kelvin: Some(512.5),
        critical_pressure_pascal: Some(8_084_000.0),
        density: Some(792.0),
    ...
    RawSubstance {
        ...
        boiling_point_kelvin: None,
        critical_temperature_kelvin: Some(647.096),
        critical_pressure_pascal: Some(22_064_000.0),
        density: Some(1000.0),
        molar_heat_capacity: None,
